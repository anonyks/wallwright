...
extension AppDelegate: NSMenuDelegate {
    func menuWillOpen(_ menu: NSMenu) {
        ...
        // `sample()` spawns and waits on a `/bin/ps` subprocess, which isn't free — doing that
        // synchronously here blocked the exact moment the menu opens (right when the click landed).
        // Showing a placeholder immediately and filling in the real value a beat later off the main
        // thread keeps the menu itself opening instantly.
