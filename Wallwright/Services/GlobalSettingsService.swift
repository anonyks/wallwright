...
struct GlobalSettings: Codable, Equatable {
    ...
    init(from decoder: Decoder) throws {
        ...
        otherApplicationFullscreen = (try? c.decodeIfPresent(GSPlayback.self, forKey: .otherApplicationFullscreen)) ?? nil ?? .keepRunning
        otherApplicationPlayingAudio = (try? c.decodeIfPresent(GSPlayback.self, forKey: .otherApplicationPlayingAudio)) ?? nil ?? .keepRunning
        displayAsleep = (try? c.decodeIfPresent(GSPlayback.self, forKey: .displayAsleep)) ?? nil ?? .keepRunning
